...
const Create: React.FC = () => {
  ...
  // Validation errors and warnings state
  ...
  const handleSave = async () => {
    ...
    // Use fixed data if available (e.g., URLs with added https://)
    const dataToSave = validation.fixedData || formData;
    ...
    try {
      ...
      const destinationUrl = generateOriginalData(selectedType, dataToSave);
      console.log('📦 Document data being saved:', {
        ...
        destinationUrl,
        contentKeys: Object.keys(dataToSave)
      });
